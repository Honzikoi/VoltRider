...
export class DatabaseService {
    constructor(
        @Inject(MONGO_CONNECTION) private readonly mongoConnection: DatabaseConnection,
        @Inject(POSTGRES_CONNECTION) private readonly postgresConnection: DatabaseConnection,
    ) {}
